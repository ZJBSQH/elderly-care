...
目标岗位:java后端开发/ai应用开发实习生

当前主要目标:获取日常实习机会

英语能力一般,想要英语四级证书和中级软件设计证书

理论偏差,注重项目实践

# 偏好

项目目标是提高项目质量和提高开发者的理解程度,不是追求过度架构设计

如果存在更简单,更适合用户理解的方案,优先选择简单方案,而不是最复杂或最先进的方案.
